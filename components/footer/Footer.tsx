...
export const Footer = () => {
  return (
    <>
      <footer className="grid grid-cols-5 justify-between items-center mt-24 bg-[var(--black-05)] z-20 px-[15vw] py-[5vh]">
        {/* <Image
          src="/watermark.png"
          alt="Marca d'água"
          width={200}
        ...
        <h3 className="text-[#bbb] text-2xl leading-9 tracking-wide h-full text-start col-span-3">
