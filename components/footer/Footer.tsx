...
export const Footer = () => {
  return (
    <>
      <footer className="flex flex-col xl:grid xl:grid-cols-5 justify-between items-center mt-12 xl:mt-24 bg-[var(--black-05)] z-20 px-8 xl:px-[15vw] py-[5vh] xl:gap-y-0">
          ...
          <div className="grid grid-flow-col justify-evenly w-full">
            ...
            >
              <svg
                ...
                height="60px"
                viewBox="0 0 50 50"
                className="social_logo bg-[var(--icon)] p-3 rounded-lg duration-300 scale-75 2xl:scale-100"
              >
            ...
            >
              <svg
                ...
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
                className="social_logo bg-[var(--icon)]"
              >
        ...
        <div className="w-full border-t border-[var(--white-transparent)] text-[var(--text-light)] text-center row-start-2 col-span-5 mt-10 pt-4">
          {" "}
